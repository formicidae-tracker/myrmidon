...
public:
	...
	getValues(quint32 antID, const QString &key);
...
public slots:
	...
	void deleteValue(quint32 antID, const QString &key, const fort::Time &time);

	void appendDefaultValue(quint32 antID, const QString &key);
private slots:
