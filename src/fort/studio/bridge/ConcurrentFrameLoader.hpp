...
class ConcurrentFrameLoader : public QObject {
	Q_OBJECT
	Q_PROPERTY(bool done READ isDone NOTIFY done)
public:
	...
	static fort::Duration moviePositionAt(
	    const fmp::DenseMap<fmp::MovieFrameID, fm::IdentifiedFrame::Ptr>
	                     &frames,
	    fort::Duration    expectedFrameDuration,
	    fmp::MovieFrameID movieID
	);

	static fmp::MovieFrameID frameIDAt(
	    const fmp::DenseMap<fmp::MovieFrameID, fm::IdentifiedFrame::Ptr>
	                  &frames,
	    fort::Duration expectedFrameDuration,
...
public slots:
	...
	fort::Duration findAnt(quint32 antID, quint64 frameID, int direction);
signals:
...
private:
	...
	typedef fmp::DenseMap<fmp::MovieFrameID, fm::IdentifiedFrame::Ptr>
	    FramesByMovieID;
	typedef fmp::DenseMap<fmp::MovieFrameID, fm::CollisionFrame::Ptr>
	    CollisionsByMovieID;
	typedef std::tuple<
	    fmp::MovieFrameID,
