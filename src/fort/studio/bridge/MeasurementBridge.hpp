...
public:
	...
	fmp::MeasurementConstPtr measurementForCloseUp(
	    const std::string &tcuURI, fmp::MeasurementTypeID typeID
	);
...
private:
	QList<QStandardItem *> buildType(const fmp::MeasurementType::Ptr &type
	) const;
