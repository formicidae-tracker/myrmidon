...
void Capsule::rebuild() {
	...
	Eigen::Vector2d normal =
	    Eigen::Rotation2D<double>(-angle) * Eigen::Vector2d(-cc.y(), cc.x());

	Eigen::Vector2d r1Pos      = c1 - normal * d_radius1;
	Eigen::Vector2d r2Pos      = c2 - normal * d_radius2;
	Eigen::Vector2d r2Opposite = c2 + Eigen::Rotation2D<double>(angle) *
	                                      Eigen::Vector2d(-cc.y(), cc.x()) *
	                                      d_radius2;
