	...
	Ants =
		{
		 ...
		 {2,{ // 2 is kind of a Nurse
		     ...
		     .Keypoints = {
		                   ...
		                   {1,100,300,-M_PI/2,Start.Add(3*Duration::Minute+10*Duration::Second).Add(-1)},
		                   {1,100,100,M_PI,Start.Add(3*Duration::Minute+10*Duration::Second)},
		                   {1,100,100,M_PI,Start.Add(3*Duration::Minute+40*Duration::Second)},
		                   {1,300,300,M_PI/4,Start.Add(3*Duration::Minute+40*Duration::Second).Add(1)},
