...
pfmAntStaticValueType <- function(v) {
    .Call(`_FortMyrmidon_pfmAntStaticValueType`, v)
}

pfmAntStaticBool <- function() {
    .Call(`_FortMyrmidon_pfmAntStaticBool`)
}

pfmAntStaticInt <- function() {
    .Call(`_FortMyrmidon_pfmAntStaticInt`)
}

pfmAntStaticDouble <- function() {
    .Call(`_FortMyrmidon_pfmAntStaticDouble`)
}

pfmAntStaticString <- function() {
    .Call(`_FortMyrmidon_pfmAntStaticString`)
}

pfmAntStaticTime <- function() {
    .Call(`_FortMyrmidon_pfmAntStaticTime`)
}
