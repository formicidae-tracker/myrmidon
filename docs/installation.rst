...
.. warning::
   ...
   If videos fails to load in **fort-studio**, please make sure that the full
   ffmpeg version is installed with `flatpak install
   org.freedesktop.Platform.ffmpeg-full//23.08`. Unfortunately flatpak does not allow
   automatic install of extensions.
